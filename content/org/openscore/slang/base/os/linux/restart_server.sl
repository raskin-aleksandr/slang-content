...
#
####################################################
# This flow restart remote linux server thrue ssh
#
#   Inputs:
...
#
# Results:
#  SUCCESS: linux host will be restarted
#  FAILURE: linux hot cannot be restarted due to error
# 
####################################################
namespace: org.openscore.slang.base.os.linux

imports:
  ssh_command: org.openscore.slang.base.remote_command_execution.ssh
  print: org.openscore.slang.base.print
